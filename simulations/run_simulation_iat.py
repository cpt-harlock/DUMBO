...
parser.add_argument("--run_baselines", required=False, default=False, action='store_true', help="also run baseline ddsketch setups")
...
# threshold is mandatory if model type is synthetic with ap
...
#hh_buckets = int(math.floor((avg_flows_per_trace*args.hh_perc)/hh_load_factor))
...
# ddsketch
ddsketch_min = 0.000001
ddsketch_max = 60
# bin size and bin number are hardcoded because the simulation evaluates multiple configurations
...
output_dir = "./results/simu_output/{}/{}/top_{}_pct/iat".format(trace, 'tcp' if args.tcp_only else 'all', args.hh_perc)
...
if args.pheavy:
    ...
    extra_mem = ((17 + flow_fingerprint_size) - flow_manager_slot_size)*flow_manager_rows*flow_manager_slots
    penalty_hh = math.ceil(extra_mem/(bins_hh*2)*2)  # allocate less hh for pHeavy as its flow manager takes more space
    max_hh = int(max_hh-penalty_hh)
    flow_manager_rows = int(flow_manager_rows*0.96)  # emulate fm load factor on pheavy (is implemented as an array with oldest eviction, very powerful but not really feasible)
...
if 'uni' in args.pcap and not args.pheavy:
    ...
    fm_type = "hierarchical"

#    flow_manager_rows = 9375
...
if args.type == "random":
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("random", args.pcap, "-", "-", "-", output_dir, output_suffix, fm_type, flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, fm_proportions_str, bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, 0.5, 0.0, 0.0, 0.0, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
elif args.type == "oracle":
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("oracle", args.pcap, ground_truth_file, "-", "-", output_dir, output_suffix, fm_type, flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, fm_proportions_str, bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, 0.5, 0.0, 0.0, 0.0, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
elif args.type == "synth" and args.pheavy:
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("synth-rates", args.pcap, ground_truth_file, "-", "-", output_dir, output_suffix, "evict-oldest", flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, "-", bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, 0.0, 0.0, args.fnr, args.fpr, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
elif args.type == "synth" and args.ap:
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("synth-ap", args.pcap, ground_truth_file, "-", "-", output_dir, output_suffix, fm_type, flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, fm_proportions_str, bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, threshold, args.ap, 0.0, 0.0, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
elif args.type == "synth":
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("synth-rates", args.pcap, ground_truth_file, "-", "-", output_dir, output_suffix, fm_type, flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, fm_proportions_str, bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, 0.0, 0.0, args.fnr, args.fpr, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
elif args.type == "onnx":
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("five-tuple-aggr", args.pcap, args.model, args.features, "-", output_dir, "coda", fm_type, flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, fm_proportions_str, bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, 0.5, 0.0, 0.0, 0.0, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
elif args.type == "onnx-pre-bins":
    cmd_string = "{} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {} {}".format("onnx-pre-bins", args.pcap, args.model, args.features, args.bins, output_dir, "coda", fm_type, flow_manager_rows, flow_manager_slots, flow_manager_slot_size, 5, fm_proportions_str, bf_m, bf_k, ddsketch_max, ddsketch_min, max_hh, 0.5, 0.0, 0.0, 0.0, '--run-baselines' if args.run_baselines else '', '--tcp-only' if args.tcp_only else '')
    cmd_string = "./target/release/simulation_iat_fm " + cmd_string
else:
