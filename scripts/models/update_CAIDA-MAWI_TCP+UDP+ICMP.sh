...
# Usage: ./update_CAIDA-MAWI_TCP+UDP+ICMP.sh {data_folder} {results_folder} {protocols} {n_pk} {shrinking_level} {rs_results} {dry_run_nsamples}
...
--n-jobs 25 \
--n-pk ${n_pk} \
--hyperparams ./training/params/params_pipeline_500KB.json \
